...
angular.module("ngTableDemos", []);
  ...
  angular.module("ngTableDemos").factory("ngTableGroupedList", dataFactory2);
  ...
  angular.module("ngTableDemos").factory("ngTableDemoCountries", dataFactory3);

  dataFactory.$inject = ["ngTableSimpleMediumList"];

  function dataFactory3(ngTableSimpleMediumList) {
  ...
  angular.module("ngTableDemos").factory("ngTableNestedMediumList", dataFactory4);

  dataFactory.$inject = ["ngTableSimpleMediumList"];

  function dataFactory4(ngTableSimpleMediumList) {
  ...
  angular.module("ngTableDemos").factory("ngTableSimpleMediumList", dataFactory5);

  dataFactory.$inject = [];

  function dataFactory5() {
